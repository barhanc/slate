...
`)}get variablesInfo(){if(this.uniforms.length===0)return;const e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},sl=(e,t)=>new Yi(e,t),$n=(e,t)=>{const n=e.length,r=[];for(let s=0;s<n;s++){const i=n-1-s,a=e[i]||1;(t[t.length-1-s]||1)>1&&a===1&&r.unshift(i)}return r}}}),Qi,Cr,Ji,ea,ta,Ce,il,al,dt=C({"web/lib/wasm/jsep/webgpu/ops/transpose.ts"(){q(),G(),he(),Z(),Qi=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Cr=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Ji=(e,t)=>S.sortBasedOnPerm(e,Cr(e.length,t)),ea=(e,t,n,r)=>{let s=`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`;for(let i=0;i<t;++i)s+=n.indicesSet("a",e[i],`i[${i}]`);return s+="return a;}"},ta=(e,t)=>{const n=[],r=[];for(let s=0;s<e.length;++s)e[s]!==1&&n.push(e[s]),e[t[s]]!==1&&r.push(t[s]);return{newShape:n,newPerm:r}},Ce=(e,t)=>{const n=e.dataType,r=e.dims.length,s=Cr(r,t),i=Ji(e.dims,s),{newShape:a,newPerm:o}=ta(e.dims,s),u=S.areEqual(o,[2,3,1]),c=S.areEqual(o,[3,1,2]),l=a.length===2&&o[0]>o[1]||u||c;let d=l?a:e.dims,p=i;l&&(d=u?[a[0],a[1]*a[2]]:c?[a[0]*a[1],a[2]]:a,p=[d[1],d[0]]);const f=I("a",n,d.length),h=N("output",n,p.length),m=16;let y;return l?y=_=>`
...
`)},Wa=(e,t,n,r)=>{const s=S.size(n),i=new Array(e.length),a=new Array(e.length);let o=0;const u=[],c=[],l=[{type:12,data:s}];for(let m=0;m<e.length;++m)o+=e[m].dims[t],i[m]=o,c.push(e[m].dims.length),a[m]=I(`input${m}`,r,c[m]),u.push("rank"),l.push({type:12,data:i[m]});for(let m=0;m<e.length;++m)l.push(...M(e[m].dims));l.push(...M(n));const d=N("output",r,n.length),p=d.indicesGet("indices",t),f=Array.from(Array(i.length).keys()).map(m=>`uniforms.sizeInConcatAxis${m}`).join(","),h=m=>`
...
bIndices[${v-2}] = u32(row);
    ...
    `},ci=(e,t,n,r,s=!1,i)=>{const a=e[0].dims,o=e[1].dims,u=a.slice(0,-2),c=o.slice(0,-2),l=r?r.slice(0,-2):n.slice(0,-2),d=S.size(l),p=a[a.length-2],f=a[a.length-1],h=o[o.length-1],m=f%4===0&&h%4===0,y=p<=8?[4,1,1]:[4,4,1],_=[8,8,1],g=[Math.ceil(h/_[0]/y[0]),Math.ceil(p/_[1]/y[1]),Math.ceil(d/_[2]/y[2])],v=m?4:1,w=[...u,p,f/v],$=w.length,x=[...c,f,h/v],b=x.length,k=[d,p,h/v],R=[{type:6,data:p},{type:6,data:h},{type:6,data:f}];ct(t,R),R.push(...M(l,w,x));const O=["rank","rank"],T=e.length>2;T&&(R.push(...M(e[2].dims)),O.push("rank")),R.push(...M(k));const ne=ee=>{const Q=l.length,de=ni("batchDims",e[0].dataType,Q,1),V=me(e[0].dataType),ie=I("a",e[0].dataType,$,v),le=I("b",e[1].dataType,b,v),L=N("result",e[0].dataType,k.length,v),te=[ie,le];if(T){const j=s?v:1;te.push(I("bias",e[2].dataType,e[2].dims.length,j))}const H=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];lt(t,H);const K=me(L.type.tensor),X=ut(t,L.type.value,K),A=Ha(v,T,X,[de,ie,le,L],[u,c,l],s);return`
  ...
  ${m?nr(y,_,V,de):rr(y,_,V,de)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${$}) {
      ...
      }`;const H=I("x",e[0].dataType,e[0].dims.length,$===3?1:$),K=I("w",e[1].dataType,e[1].dims.length,le),X=[H,K],A=N("result",e[0].dataType,n.length,le);if(a){const j=I("bias",e[2].dataType,e[2].dims.length,le);X.push(j),te+=`
...
`}return H};return`
  ...
  fn setOutputAtIndex(flatIndex : u32, value : ${i?`vec4<${a}>`:a}) {
    ...
    }`);const h=i?4:1,m=I("W",t[1].dataType,t[1].dims.length,h),y=I("Dy",t[0].dataType,t[0].dims.length,h),_=[y,m];r&&_.push(I("bias",t[2].dataType,[n[d]].length,h));const g=N("result",t[0].dataType,n.length,h),v=`{
...
`)},yo=(e,t)=>{let n,r,s,i,a,o;const u=t.format==="NHWC",c=t.blocksize,l=t.mode==="DCR";u?([n,r,s,i]=e.dims,a=l?[n,r,s,c,c,i/c**2]:[n,r,s,i/c**2,c,c],o=l?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([n,r,s,i]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],a=l?[n,c,c,i/c**2,r,s]:[n,i/c**2,c,c,r,s],o=l?[0,3,4,1,5,2]:[0,1,4,2,5,3]);const d=e.reshape(a),p=d.dims.length,f=e.dataType,h=I("a",f,p),m=N("output",f,p),y=_=>`
...
`)};
    ...
    ${p}`},u=[{type:12,data:a},...M(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length}`,inputDependencies:["rank"]},getShaderSource:o,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:u})}},qd=e=>{xo(e.inputs),e.compute(ko(e.inputs),{inputs:[0]})}}}),Io,Wd,$y=C({"web/lib/wasm/jsep/webgpu/ops/fast-gelu.ts"(){q(),G(),Z(),ii(),Io=e=>{const t=e[0].dataType,n=S.size(e[0].dims),r=S.size(e[1].dims),s=r%4===0,i=a=>{const o=I("x",t,[1],4),u=I("bias",t,[1],4),c=N("y",t,[1],4),l=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],d=f=>`
    ...
    ${a.mainStart(Pt)}
      ...
      ${p.mainStart()}
        ...
        ${v.setByOffset("global_idx","dequantized_data")};
                     ...
                     indices input tensors be of same rank.`)},Oo=(e,t)=>{const n=e[0].dims,r=e[0].dataType,s=n.length,i=e[1].dims,a=e[1].dataType,o=S.normalizeAxis(t.axis,s),u=n[o],c=i.slice(0),l=S.size(c),d=I("input",r,s),p=I("indicesInput",a,i.length),f=N("output",r,c.length),h=[{type:12,data:l},{type:6,data:u},{type:12,data:o}];return h.push(...M(n,i,c)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:c,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:h}),getShaderSource:_=>`
  ...
  ${y.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${v(0)}, ${v(1)});
       ...
       Got scale size of ${d} and bias size of ${p}`);const f=[];for(let $=0;$<s.length;++$)$<u?f.push(s[$]):f.push(1);const h=fe(l),m=["type","type"],y=[{type:12,data:c},{type:1,data:l},{type:12,data:Math.floor(l/h)},{type:1,data:t.epsilon}];a&&m.push("type");const _=n>1,g=n>2,v=$=>{const x=me(e[0].dataType),b=[I("x",e[0].dataType,e[0].dims,h),I("scale",i.dataType,i.dims,h)];a&&b.push(I("bias",a.dataType,a.dims,h)),b.push(N("output",e[0].dataType,o,h)),_&&b.push(N("mean_data_output",1,f)),g&&b.push(N("inv_std_output",1,f));const k=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${$.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${f};${h};${y};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:m,dataType:d}],dispatchGroup:{x:_},programUniforms:v}),getShaderSource:b}},Zo=(e,t)=>{const n=e[0].dims,r=n.length,s=n[r-2],i=t.k,a=t.n,o=n.slice(0,r-2),u=S.size(o),l=e[1].dims[2]/4,d=e[0].dataType,p=fe(t.k),f=fe(l),h=o.concat([s,a]),m=128,y=a%8===0?8:a%4===0?4:1,_=m/y,g=_*f*8,v=g/p,w=g/t.blockSize,$=S.size(h)/y,x=[],b=[u,s,i/p],k=S.convertShape(e[1].dims).slice();k.splice(-1,1,l/f),x.push(...M(b)),x.push(...M(k)),x.push(...M(e[2].dims)),e.length===4&&x.push(...M(S.convertShape(e[3].dims)));const R=[u,s,a];x.push(...M(R));const O=T=>{const ne=b.length,ee=I("a",e[0].dataType,ne,p),Q=I("b",12,k.length,f),de=I("scales",e[2].dataType,e[2].dims.length),V=[ee,Q,de],ie=e.length===4?I("zero_points",12,e[3].dims.length):void 0;ie&&V.push(ie);const le=R.length,L=N("output",e[0].dataType,le),te=me(e[0].dataType),H=()=>{switch(p){case 1:return`
...
`:"",vu=(e,t,n,r,s)=>{const[i,a,o,u]=n.length===2?[-1,0,1,-1]:[0,2,3,1],c=e.type.value;return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${f} {
    ...
    }`},bu=(e,t,n,r,s,i)=>{const a=e.dims,o=fu(i,t.axes,a.length);let u=hu(a,r,s,t.axes),c=r.slice();r.length===0&&(c=a.map((g,v)=>g===0?1:u[v]/g),t.keepAspectRatioPolicy!=="stretch"&&(u=mu(a,c,t)));const l=N("output",e.dataType,u.length),d=I("input",e.dataType,a.length),p=S.size(u),f=a.length===u.length&&a.every((g,v)=>g===u[v]),h=t.coordinateTransformMode==="tf_crop_and_resize",m=t.extrapolationValue,y=d.type.value,_=g=>`
      ${f?"":`
